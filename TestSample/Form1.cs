...
namespace TestSample
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void cmdSwap_Click(object sender, EventArgs e)
        {
            ...
            Transition t = new Transition(new TransitionTypeEaseInEaseOut(1000));
        ...
        private void cmdBounceMe_Click(object sender, EventArgs e)
        {
            ...
            Transition.Run(cmdBounceMe, "Top", iDestination, new TransitionTypeBounce(1500));
        }
        ...
        private void cmdThrowAndCatch_Click(object sender, EventArgs e)
        {
            ...
            Transition.Run(cmdThrowAndCatch, "Top", 12, new TransitionTypeThrowAndCatch(1500));
        }
        ...
        private void cmdFlashMe_Click(object sender, EventArgs e)
        {
            ...
            // of each flash...
            Transition.Run(cmdFlashMe, "BackColor", Color.Pink, new TransitionTypeFlash(2, 300));
        }
        ...
        private void ctrlChangeFormColor_Click(object sender, EventArgs e)
        {
            ...
            Transition.Run(this, "BackColor", destination, new TransitionTypeLinear(1000));
        }
        ...
        private void cmdMore_Click(object sender, EventArgs e)
        {
            ...
            Transition.Run(this, "Width", iFormWidth, new TransitionTypeEaseInEaseOut(1000));
        }
        ...
        private void cmdDropAndBounce_Click(object sender, EventArgs e)
        {
            ...
            Transition.Run(cmdDropAndBounce, "Top", iDestination, new TransitionTypeUserDefined(elements, 2000));
            ...
            Transition t1 = new Transition(new TransitionTypeLinear(2000));
            t1.Add(cmdDropAndBounce, "Left", cmdDropAndBounce.Left + 400);

            Transition t2 = new Transition(new TransitionTypeEaseInEaseOut(2000));
